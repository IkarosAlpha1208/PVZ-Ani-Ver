...
public class ClockFaust extends Plant {
    ...
    public ClockFaust(int x, int y) {
        super(100, 300, 2, 15, 400, x, y, new Rectangle(x, y, 36, 48));
        this.name = "Faust-Eternal";
        this.stat = "";
        this.id = 17;
        this.lastAttack = 0;
        this.describe = "High damage and knock zombie back";
        try {
    ...
    public void attack(ArrayList<Projectile> projectileList) {
        ...
        if ((currentTime - lastAttack)/1000.0 >= atkSpd) {
            ...
            projectileList.add(new clock(5, atk, "none", this.x - 10, this.y + 10));
        }
    }
