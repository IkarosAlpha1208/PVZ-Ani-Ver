...
//same as slash but it only disapear after it hit wall
public class slashP extends Projectile{
    public slashP(int speed, int damage, String stat, int x, int y) {
        super(speed, damage, stat, x, y);
        try {
            this.img = ImageIO.read(new File("assets/projectiles/slash.png"));
        ...
        try {
            sound = AudioSystem.getAudioInputStream(new File("assets/sound/slash.wav"));
